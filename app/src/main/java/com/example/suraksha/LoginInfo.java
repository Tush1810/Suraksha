...
//                addChild();
                ...
                Toast.makeText(this, "Contact entered at the last field already exists", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        Log.i("Saving name-",editText.getText().toString());
        myPrefs.edit().putString("name",editText.getText().toString()).apply();
        ...
        startActivity(new Intent(LoginInfo.this,sosPage.class));
    }

    public void openDirectory(View view){
        if(ActivityCompat.checkSelfPermission(LoginInfo.this, Manifest.permission.READ_CONTACTS)
                != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(LoginInfo.this,new String[]{Manifest.permission.READ_CONTACTS},3);
        }
        if(ActivityCompat.checkSelfPermission(LoginInfo.this, Manifest.permission.READ_CONTACTS)
                == PackageManager.PERMISSION_GRANTED){
            contactsActivity();
...
//                            alertdialogueBuilder.show();
    ...
    public void addChild(){
        ...
        EditText editText=new EditText(LoginInfo.this);

        Resources r=LoginInfo.this.getResources();
